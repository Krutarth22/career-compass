...
CareerCompass's own scripts/ (resolution.py, project_planner.py, gap_state.py).
"""
...
# resolution.py lives in the sibling career-compass skill's scripts/ directory —
...
_CAREER_COMPASS_SCRIPTS = Path(__file__).resolve().parents[2] / "career-compass" / "scripts"
if str(_CAREER_COMPASS_SCRIPTS) not in sys.path:
    sys.path.insert(0, str(_CAREER_COMPASS_SCRIPTS))
